...
class CheckoutController extends Controller
{
    ...
    public function addOrder(Request $request){
        ...
        if($request->payment_type == 'pay_later'){
            ...
            return redirect('checkout/result')->with('notification', 'Thanh toán thành công! Vui lòng kiểm tra email của bạn');
        }
    ...
    public function vnPayCheck(Request $request){
        ...
        if($vnp_ResponseCode != null){
            ...
            if($vnp_ResponseCode == 00){
                ...
                Cart::destroy();
                //thông báo kết quả
                return redirect('checkout/result')->with('notification', 'Thanh toán thành công vui lòng kiểm tra email!');

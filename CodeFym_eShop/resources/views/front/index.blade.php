            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-1">
                    ...
                    <div class="product-slider owl-carousel women">
                        @foreach($featuredProducts['women'] as $womanProduct)
                        <div class="product-item item {{$womanProduct->tag}}">
                            <div class="pi-pic">
                                <img src="front/img/products/{{$womanProduct->productImage[0]->path}}" alt="">
                                ...
                                <ul>
                                    ...
                                    <li class="quick-view"><a href="shop/product/{{$womanProduct->id}}">+ Quick View</a></li>
                                    <li class="w-icon"><a href="#"><i class="fa fa-random"></i></a></li>
                                </ul>
                            </div>
                            <div class="pi-text">
                                <div class="catagory-name">{{$womanProduct->tag}}</div>
                                <a href="shop/product/{{$womanProduct->id}}">
                                    <h5>{{$womanProduct->name}}</h5>
                                </a>
                                <div class="product-price">
                                    @if($womanProduct->discount!=null)
                                        {{$womanProduct->discount}} VND
                                        <span>{{$womanProduct->price}}</span>
                                    @else
                                        {{$womanProduct->price}} VND
                                    @endif
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="product-slider owl-carousel men">
                        ...
                        <div class="product-item item {{$menProduct->tag}}">
                            <div class="pi-pic">
                                <img src="front/img/products/{{$menProduct->productImage[0]->path}}" alt="">
                            ...
                            <div class="pi-text">
                                ...
                                <div class="product-price">
                                    @if($menProduct->discount!=null)
                                        {{$menProduct->discount}} VND
                                        <span>{{$menProduct->price}}</span>
                                    @else
                                        {{$menProduct->price}} VND
                                    @endif
                                </div>
                            </div>
                        </div>
